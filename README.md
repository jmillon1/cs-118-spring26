...
Senario: You are the lead programmer of a project and one of your team members has recently made a new
commit to the projects repository. Assume this is your first time working on this repository and your
machine has Git configred already.

Navigate to the github.com/jmillon1/cs-118-spring26 in your web browser.
Locate the 'Fork' button and click the drop down menu and select "+ create a new fork".
